  ...
  <i class="fas fa-sign-out-alt"></i> Logout
    ...
    <div class="maincontent" id="maincontent">
       ...
       <div class="form-group">
            <label for="fileAttachment">Attachment:<br></label>
            <div class="file-input-container">
                <input type="file" id="fileAttachment" class="file-input">
                <span id="fileName" class="file-name">Please upload a copy of your student card</span>
            </div>
        </div>
